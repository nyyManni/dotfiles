...
#+BEGIN_SRC emacs-lisp
  ...
  (bind-key (kbd "C-<f9>") 'my-edit-config)
#+END_SRC
**** UI tweaks
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun my-shell-compile ()
    ...
    (add-hook 'python-mode-hook '(lambda ()
      (define-key python-mode-map (kbd "<f5>") 'my-run-pdb-current-file)
      (define-key python-mode-map (kbd "C-S-<f5>") 'my-quit-pdb)
      (define-key python-mode-map (kbd "<f9>") 'gud-break)
      (define-key python-mode-map (kbd "S-<f9>") 'gud-remove)
      (define-key python-mode-map (kbd "<f10>") 'gud-next)
      (define-key python-mode-map (kbd "<f11>") 'gud-step)
      (define-key python-mode-map (kbd "C-<f11>") 'my-quit-pdb)
